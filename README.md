# Advanced Programming Array Visualizer
This is one of three AI projects I worked on at South East Technological University. It explores how AI can be used to support the rapid production of data structures and algorithms visualisers. The project allocated 15 hours of AI-assisted development. This repository represents the array visualiser, which used 5 of those hours. You can navigate to each project below.

- Array Visualizer
- [Binary Search Tree Visualizer](https://github.com/DarianByrne/AdvancedProgrammingBinarySearchTreeVisualizer/)
- [Linked List Visualizer](https://github.com/DarianByrne/AdvancedProgrammingLinkedListVisualizer/)
